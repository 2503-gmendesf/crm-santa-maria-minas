...
create table if not exists leads (
  ...
  serie_interesse     text[] not null default '{}',
...
-- ============================================================
-- MIGRAÇÃO: alterar serie_interesse para array (text[])
-- Execute APENAS se a tabela "leads" já existia com text simples:
-- ============================================================
-- alter table leads
--   alter column serie_interesse type text[]
--   using array[serie_interesse];

-- MIGRAÇÃO: adicionar campo data_primeiro_contato
-- Execute se a tabela já existia:
